...
use crate::types::{
    ...
    BridgeActionType, EmergencyAction, EthLog, EthToStarcoinBridgeAction, EvmAddMemberAction,
    EvmContractUpgradeAction, LimitUpdateAction, StarcoinToEthBridgeAction,
};
        ...
        Ok(match self {
            EthBridgeEvent::EthStarcoinBridgeEvents(event) => {
                match event {
                    ...
                    EthStarcoinBridgeEvents::TokensClaimedFilter(_) => None,
                    EthStarcoinBridgeEvents::TransferApprovedFilter(_) => None,
                    EthStarcoinBridgeEvents::PausedFilter(_) => None,
                    EthStarcoinBridgeEvents::UnpausedFilter(_) => None,
                    EthStarcoinBridgeEvents::UpgradedFilter(_) => None,
                    EthStarcoinBridgeEvents::InitializedFilter(_) => None,
                    EthStarcoinBridgeEvents::ContractUpgradedFilter(_) => None,
                    EthStarcoinBridgeEvents::EmergencyOperationFilter(_) => None,
                }
            }
            EthBridgeEvent::EthBridgeCommitteeEvents(event) => match event {
                EthBridgeCommitteeEvents::BlocklistUpdatedFilter(_) => None,
                EthBridgeCommitteeEvents::InitializedFilter(_) => None,
                EthBridgeCommitteeEvents::UpgradedFilter(_) => None,
                EthBridgeCommitteeEvents::BlocklistUpdatedV2Filter(_) => None,
                EthBridgeCommitteeEvents::ContractUpgradedFilter(_) => None,
                EthBridgeCommitteeEvents::MemberAddedFilter(_) => None,
            },
            EthBridgeEvent::EthBridgeLimiterEvents(event) => match event {
                EthBridgeLimiterEvents::LimitUpdatedFilter(_) => None,
                EthBridgeLimiterEvents::InitializedFilter(_) => None,
                EthBridgeLimiterEvents::UpgradedFilter(_) => None,
                EthBridgeLimiterEvents::HourlyTransferAmountUpdatedFilter(_) => None,
                EthBridgeLimiterEvents::OwnershipTransferredFilter(_) => None,
                EthBridgeLimiterEvents::ContractUpgradedFilter(_) => None,
                EthBridgeLimiterEvents::LimitUpdatedV2Filter(_) => None,
            },
            EthBridgeEvent::EthBridgeConfigEvents(event) => match event {
                EthBridgeConfigEvents::InitializedFilter(_) => None,
                EthBridgeConfigEvents::UpgradedFilter(_) => None,
                EthBridgeConfigEvents::TokenAddedFilter(_) => None,
                EthBridgeConfigEvents::TokenPriceUpdatedFilter(_) => None,
                EthBridgeConfigEvents::ContractUpgradedFilter(_) => None,
                EthBridgeConfigEvents::TokenPriceUpdatedV2Filter(_) => None,
                EthBridgeConfigEvents::TokensAddedV2Filter(_) => None,
            },
            EthBridgeEvent::EthCommitteeUpgradeableContractEvents(event) => match event {
                EthCommitteeUpgradeableContractEvents::InitializedFilter(_) => None,
                EthCommitteeUpgradeableContractEvents::UpgradedFilter(_) => None,
            },
        })
    }
}
...
impl TryFrom<EvmAddMemberAction> for eth_bridge_committee::Message {
    type Error = BridgeError;

    fn try_from(action: EvmAddMemberAction) -> BridgeResult<Self> {
        use crate::encoding::EVM_ADD_MEMBER_MESSAGE_VERSION;
        Ok(eth_bridge_committee::Message {
            message_type: BridgeActionType::UpdateCommitteeMember as u8,
            version: EVM_ADD_MEMBER_MESSAGE_VERSION,
            nonce: action.nonce,
            chain_id: action.chain_id as u8,
            payload: action
                .as_payload_bytes()
