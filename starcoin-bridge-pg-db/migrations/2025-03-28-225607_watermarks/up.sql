...
(
    -- The pipeline governed by this watermark, i.e `epochs`, `blocks`,
    -- `transactions`.
    ...
    -- Inclusive upper block bound for this entity's data. Committer
    -- updates this field. All data of this entity in the block must be
    -- persisted before advancing this watermark. The committer refers to this
    -- on disaster recovery to resume writing.
    block_hi_inclusive          BIGINT        NOT NULL,
    ...
    -- this field once it can guarantee that all blocks at or before this
    ...
    -- epoch id, block number, or tx sequence number depending on
