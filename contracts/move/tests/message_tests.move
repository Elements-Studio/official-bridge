...
module Bridge::MessageTests {
    ...
    fun test_add_tokens_on_starcoin_message_serialization_2() {
        ...
        // The recovered pubkey is in raw 64-byte format (uncompressed without 0x04 prefix)
        // X coordinate: 321ede33d2c2d7a8a152f275a1484edef2098f034121a602cb7d767d38680aa4
        // Y coordinate: abcfe1a969c7143c8a983cfa9e44ff6494e9802ebff1db64df53ff1c992f556c
        // Compressed pubkey would be: 02321ede... (02 prefix because Y's last byte 0x6c is even)
        let expected_raw_pubkey = x"321ede33d2c2d7a8a152f275a1484edef2098f034121a602cb7d767d38680aa4abcfe1a969c7143c8a983cfa9e44ff6494e9802ebff1db64df53ff1c992f556c";
        assert!(pubkey == expected_raw_pubkey, 4);
        Treasury::destroy(treasury);
    }
    ...
    fun test_update_committee_member_message_serialization() {
        ...
        let bridge_pubkey_bytes = x"029bef8d556d80e43ae7e0becb3a7e6838b95defe45896ed6075bb9035d06c9964";
