...
contract BridgeLimiterTest is BridgeBaseTest {
    ...
    function testMultipleChainLimits() public {
        ...
        _supportedTokens[0] = address(0); // STC
        ...
        address _config = Upgrades.deployUUPSProxy(
            ...
            abi.encodeCall(
                ...
                (address(committee), chainID, _supportedTokens, tokenPrices, tokenIds, starcoinDecimals, supportedChains, 10)
            ),
            opts
        );
    ...
    function testUpdateLimitRegressionTest() public {
        ...
        address _config = Upgrades.deployUUPSProxy(
            ...
            abi.encodeCall(
                BridgeConfig.initialize,
                (address(committee), chainID, supportedTokens, tokenPrices, tokenIds, starcoinDecimals, _supportedChains, 10)
            ),
            opts
        );
        ...
        bytes memory expectedEncodedMessage =
            hex"53544152434f494e5f4252494447455f4d4553534147450301000000000000000f020c00000002540be400";
    ...
    function testUpdateLimitRegressionTestWithSigVerficiation() public {
        ...
        bytes memory encodedMessage = BridgeUtils.encodeMessage(message);
        bytes memory expectedEncodedMessage =
            hex"53544152434f494e5f4252494447455f4d455353414745030100000000000000000b0100000915fa66bc00";
