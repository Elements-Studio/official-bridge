...
contract BridgeBaseTest is Test {
    ...
    function setUpBridgeTest() public {
        ...
        starcoinDecimals = new uint8[](5);
        tokenIds = new uint8[](5);
        starcoinDecimals[0] = 9;
        starcoinDecimals[1] = 8;
        starcoinDecimals[2] = 8;
        starcoinDecimals[3] = 6;
        starcoinDecimals[4] = 6;
        tokenPrices[0] = STC_PRICE;
