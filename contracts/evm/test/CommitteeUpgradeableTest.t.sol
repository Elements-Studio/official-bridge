...
contract CommitteeUpgradeableTest is BridgeBaseTest {
    ...
    function setUp() public {
        ...
        address _config = Upgrades.deployUUPSProxy(
            ...
            abi.encodeCall(
                ...
                (_committee, _chainID, supportedTokens, tokenPrices, tokenIds, starcoinDecimals, _supportedDestinationChains, 10)
            ),
            opts
        );
        ...
        address _bridge = Upgrades.deployUUPSProxy(
            "StarcoinBridge.sol",
            abi.encodeCall(StarcoinBridge.initialize, (_committee, address(0), address(0))),
            opts
        );

        bridge = StarcoinBridge(_bridge);
        bridgeV2 = new MockStarcoinBridgeV2();
    }

    function testUpgradeWithSignaturesSuccess() public {
        bytes memory initializer = abi.encodeCall(MockStarcoinBridgeV2.initializeV2, ());
    ...
    function testUpgradeRegressionTestWithV2Initializer() public {
        bytes memory messagePrefix = hex"53544152434f494e5f4252494447455f4d455353414745050100000000000000000c";
    ...
    function testUpgradeRegressionTestWith1CalldataArg() public {
        ...
        MockStarcoinBridgeV2 newBridgeV2 = MockStarcoinBridgeV2(address(bridge));
    ...
    function testUpgradeRegressionTestWithNoCalldata() public {
        ...
        MockStarcoinBridgeV2(address(bridge));
        assertEq(Upgrades.getImplementationAddress(address(bridge)), address(bridgeV2));
    }
}
