...
/// @title IStarcoinBridge
/// @dev Interface for the Starcoin Bridge contract.
interface IStarcoinBridge {
    ...
    /// @param starcoinAdjustedAmount The amount of tokens to transfer, adjusted for Starcoin decimals.
    ...
    /// @notice Emitted when a transfer is approved but pending claim (due to delay).
    /// @param sourceChainID The ID of the source chain.
    /// @param nonce The nonce of the transaction on source chain.
    /// @param destinationChainID The ID of the destination chain (this chain).
    /// @param tokenID The code of the token.
    /// @param erc20AdjustedAmount The amount of tokens approved, adjusted for ERC20 decimals.
    /// @param senderAddress The address of the sender.
    /// @param recipientAddress The address of the recipient.
    /// @param approvalTimestamp The timestamp when the transfer was approved.
