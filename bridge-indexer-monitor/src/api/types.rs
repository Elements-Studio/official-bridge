...
/// Bridge status response - returns paused state for both chains
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct BridgeStatusResponse {
    /// Whether ETH bridge is paused
    pub eth_paused: bool,
    /// Whether Starcoin bridge is paused (frozen)
    pub stc_paused: bool,
    /// Error messages if any chain query failed
