...
pub(super) fn compute_base_2w_expansion(bytes: &[u8], bits_per_digit: usize) -> Vec<usize> {
...
#[inline]
pub(super) fn get_bits_from_bytes(bytes: &[u8], start: usize, end: usize) -> usize {
...
// return false.
#[inline]
pub(super) fn test_bit(bytes: &[u8], index: usize) -> bool {
...
pub(super) const fn log2(x: usize) -> usize {
    (usize::BITS - x.leading_zeros() - 1) as usize
}

// Return true iff the given number is a power of 2.
pub(super) fn is_power_of_2(x: usize) -> bool {
    if x == 0 {
        return false;
    }
    x & (x - 1) == 0
