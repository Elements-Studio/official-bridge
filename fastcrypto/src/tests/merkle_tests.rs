...
fn test_non_inclusion_single_leaf() {
    ...
    let non_inclusion_proof = mt
        ...
        .unwrap();
    tracing::debug!("non_inclusion_proof: {:?}", non_inclusion_proof);
    assert!(non_inclusion_proof
        .verify_proof(&mt.root(), &"bar".as_bytes())
        .is_ok());
    assert!(non_inclusion_proof
...
fn test_non_inclusion_multiple_leaves() {
    ...
    tracing::debug!("sorted_test_input: {:?}", sorted_test_input);
    ...
    tracing::debug!("test_cases: {:?}", test_cases);
...
fn test_serialization_with_blake2b256() {
    ...
    tracing::debug!("serialized_inclusion: {:?}", serialized_inclusion);
    ...
    tracing::debug!("serialized_non_inclusion: {:?}", serialized_non_inclusion);
